...
interface ErrorBoundaryProps {
  /** Optional name for the guarded section (shown in fallback UI + console) */
  name?: string;
...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  private defaultFallback(error: Error): preact.VNode {
    ...
    return (
      ...
      >
        ...
        <span style={{ fontSize: "10px", color: colors.textMuted, maxWidth: "240px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
