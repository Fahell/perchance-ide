...
// ─── JS/TS extractor ────────────────────────────────────────
function extractJSSymbols(view: EditorView): OutlineSymbol[] {
...
// ─── CSS extractor ──────────────────────────────────────────
function extractCSSSymbols(view: EditorView): OutlineSymbol[] {
  const symbols: OutlineSymbol[] = [];
  syntaxTree(view.state).iterate({
    enter: (nodeRef) => {
      const { name: nodeName, from, to } = nodeRef;
...
// ─── HTML extractor ─────────────────────────────────────────
function extractHTMLSymbols(view: EditorView): OutlineSymbol[] {
  const symbols: OutlineSymbol[] = [];
...
// ─── Main entry ─────────────────────────────────────────────
export function extractSymbols(view: EditorView): OutlineSymbol[] {
  if (!view) return [];
