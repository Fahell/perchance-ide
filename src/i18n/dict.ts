...
const en: Translations = {
  ...
  "settings.terminalFontSize.desc": "text size in the interactive terminal (applied on next open)",
  ...
  "settings.validate.invalidKey": "invalid api key",
  "settings.validate.noCredit": "out of credits. add credits at jina.ai",
  "settings.validate.rateLimited": "rate limited. wait and try again",
  "settings.validate.network": "network error",
...
const ptBR: Translations = {
  ...
  "settings.terminalFontSize": "fonte do terminal",
  "settings.terminalFontSize.desc": "tamanho do texto no terminal interativo (aplicado na próxima abertura)",
  ...
  "settings.validate.invalidKey": "chave api inválida",
  "settings.validate.noCredit": "sem créditos. adicione créditos em jina.ai",
  "settings.validate.rateLimited": "limite de taxa. aguarde e tente novamente",
  "settings.validate.network": "erro de rede",
...
const es: Translations = {
  ...
  "settings.terminalFontSize": "fuente del terminal",
  "settings.terminalFontSize.desc": "tamaño del texto en el terminal interactivo (aplicado en la próxima apertura)",
  ...
  "settings.validate.invalidKey": "clave api inválida",
  "settings.validate.noCredit": "sin créditos. agregue créditos en jina.ai",
  "settings.validate.rateLimited": "límite de velocidad. espera y vuelve a intentar",
  "settings.validate.network": "error de red",
...
const ja: Translations = {
  ...
  "settings.terminalFontSize.desc": "インタラクティブ端末のテキストサイズ（次回起動時に適用）",
  ...
  "settings.validate.invalidKey": "無効なAPIキー",
  "settings.validate.noCredit": "クレジット不足。jina.aiでクレジットを追加",
  "settings.validate.rateLimited": "レート制限。後でもう一度お試しください",
  "settings.validate.network": "ネットワークエラー",
  "settings.close": "閉じる",
  "panel.ready": "準備完了",
...
const zh: Translations = {
  ...
  "settings.terminalFontSize.desc": "交互终端中的文字大小（下次打开时应用）",
  ...
  "settings.validate.invalidKey": "无效的API密钥",
  "settings.validate.noCredit": "额度不足。在 jina.ai 添加额度",
  "settings.validate.rateLimited": "速率受限。请稍后再试",
  "settings.validate.network": "网络错误",
  "settings.close": "关闭",
  "panel.ready": "就绪",
  "response.label": "代理",
  "response.expand": "展开",
