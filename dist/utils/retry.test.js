...
describe("retryWithBackoff", () => {
    ...
    it("should throw after exhausting retries", async () => {
        ...
        }, { maxRetries: 2, initialDelay: 10 })).rejects.toThrow("persistent failure");
    });
    it("should NOT retry on non-retryable error", async () => {
        ...
        }, { maxRetries: 3, initialDelay: 10 })).rejects.toThrow("bad request");
    ...
    it("should support cancellation via AbortSignal", async () => {
        ...
        }, { signal: controller.signal, initialDelay: 10 })).rejects.toThrow();
    });
});
